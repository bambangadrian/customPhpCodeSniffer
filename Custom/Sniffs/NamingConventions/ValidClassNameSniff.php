...
/**
 * Custom_Sniffs_NamingConventions_ValidClassNameSniff.
 *
 ...
 * @link     https://github.com/escapestudios/Symfony2-coding-standard
 */
class Custom_Sniffs_NamingConventions_ValidClassNameSniff implements PHP_CodeSniffer_Sniff
{
    /**
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        while ($tokens[$stackPtr]['line'] == $line) {
            ...
            if ('T_ABSTRACT' == $tokens[$stackPtr]['type']) {
                ...
                if ($name && (is_null($function) || $name < $function) && substr($tokens[$name]['content'], 0,
                        8) != 'Abstract'
                ) {
                    $phpcsFile->addError(
